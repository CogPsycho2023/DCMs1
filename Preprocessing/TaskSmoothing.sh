...
#fslmaths $fMRI/$subject/fMRI$n/${input} -Tmean $fMRI/$subject/fMRI$n/mask.nii.gz

#fslmaths $fMRI/$subject/fMRI$n/mask -bin $fMRI/$subject/fMRI$n/mask.nii.gz

wb_command -volume-smoothing $fMRI/$subject/fMRI$n/${input}.nii.gz $Sigma $fMRI/$subject/fMRI$n/${input}_s${SmoothingFWHM}.nii.gz

fslmaths $fMRI/$subject/fMRI$n/${input}_s${SmoothingFWHM}.nii.gz -Tmean $fMRI/$subject/fMRI$n/mc/tempMean.nii.gz
