...
antsApplyTransforms -i $sMRI/$subject/T1w/${mask}_mask.nii.gz -r $StandardT12mm_brain -o $fMRI/$subject/fMRI$n/reg/${mask}_mask_MNI.nii.gz -t $fMRI/$subject/fMRI$n/reg/antsReg21Warp.nii.gz -t $fMRI/$subject/fMRI$n/reg/antsReg20GenericAffine.mat
...
paste $fMRI/$subject/fMRI$n/mc/CSF.txt $fMRI/$subject/fMRI$n/mc/WM.txt ${fMRI}/${subject}/fMRI${n}/mc/MotionRegressors.txt >> ${fMRI}/${subject}/fMRI${n}/mc/covariance.txt

fi 

if [ $Covariances = 27 ] ; then 

paste $fMRI/$subject/fMRI$n/mc/CSF.txt $fMRI/$subject/fMRI$n/mc/WM.txt $fMRI/$subject/fMRI$n/mc/Global.txt ${fMRI}/${subject}/fMRI${n}/mc/MotionRegressors.txt >> ${fMRI}/${subject}/fMRI${n}/mc/covariance.txt 

fi

if [ $Covariances = 24 ] ; then

cp ${fMRI}/${subject}/fMRI${n}/mc/MotionRegressors.txt ${fMRI}/${subject}/fMRI${n}/mc/covariance.txt

fi

if [ $Covariances = 25 ] ; then

paste $fMRI/$subject/fMRI$n/mc/Global.txt ${fMRI}/${subject}/fMRI${n}/mc/MotionRegressors.txt >> ${fMRI}/${subject}/fMRI${n}/mc/covariance.txt
